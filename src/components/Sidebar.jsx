...
const Sidebar = () => {
  ...
  const sharedStyle = `flex items-center gap-5 pl-4 pt-3 
  pb-2.5 rounded-lg text-white text-md `
  const activeLink = ` ${sharedStyle} m-2`
  const normalLink = `${sharedStyle} text-gray-700 dark:text-gray-200
      ...
      {activeMenu && (<>
        <div className='flex justify-between items-center'>
          <Link to="/" onClick={() => {setActiveMenu(false)}} 
            ...
            <SiShopware /> <span>Gallatian Stores</span>
          </Link>
